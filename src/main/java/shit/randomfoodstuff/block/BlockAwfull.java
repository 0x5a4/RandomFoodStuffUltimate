...
public class BlockAwfull extends BlockContainer {
	...
	public static final boolean canImmitate(World world, int x, int y, int z) {
		return canImmitate(world.getBlock(x, y, z));
	}

	public static final boolean canImmitate(Block block) {
