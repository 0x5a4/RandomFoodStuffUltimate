...
public class ItemDrink extends ItemFood {
	...
	protected void onFoodEaten(ItemStack stack, World world, EntityPlayer player) {
		switch(stack.getItemDamage()) {
		case 1:
			player.extinguish(); break;
		case 2:
			player.addPotionEffect(new PotionEffect(Potion.nightVision.id, DurationHelper.minutesToTicks(15))); break;
		case 3:
			player.addPotionEffect(new PotionEffect(Potion.damageBoost.id, DurationHelper.minutesToTicks(10), 2)); break;
		case 4:
			player.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, DurationHelper.minutesToTicks(10), 1)); break;
		}
	}
