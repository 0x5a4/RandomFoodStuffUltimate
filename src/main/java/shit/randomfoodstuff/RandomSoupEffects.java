...
import shit.randomfoodstuff.cooking.*;
...
public class RandomSoupEffects {
    ...
    private static void registerEffects() {
        ...
        SoupRegistry.registerSoupEffect("floating", new TemplateSoupEffect.Potion("Never gonna let you down", RFPotion.potionFloating.id, DurationHelper.minutesToTicks(3)).setSelfReactionEffect(RFPotion.potionFloating.id, DurationHelper.minutesToTicks(4.5F)));
        ...
        SoupRegistry.registerSoupEffect("moldy", new SoupEffect() {
            ...
            public void perform(World world, EntityPlayer player) {
                player.addPotionEffect(new PotionEffect(RFPotion.potionMoldy.id, DurationHelper.minutesToTicks(3)));
            }
            ...
            public void reactWithSelf(World world, EntityPlayer player) {
                player.addPotionEffect(new PotionEffect(RFPotion.potionMoldy.id, DurationHelper.minutesToTicks(5)));
            }
