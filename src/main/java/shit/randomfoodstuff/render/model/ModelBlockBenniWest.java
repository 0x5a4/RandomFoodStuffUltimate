...
public class ModelBlockBenniWest extends ModelBase {
	...
	public ModelBlockBenniWest() {
		...
		BodyLittle.setRotationPoint(-2F, 20F, 4F);
		BodyLittle.setTextureSize(64, 64);
		BodyLittle.mirror = true;
		setRotation(BodyLittle, 0F, 1.570796F, 0F);
		BodyBig = new ModelRenderer(this, 0, 0);
		BodyBig.addBox(0F, 0F, 0F, 8, 5, 6);
		BodyBig.setRotationPoint(-3F, 15F, 4F);
		BodyBig.setTextureSize(64, 64);
		BodyBig.mirror = true;
		setRotation(BodyBig, 0F, 1.570796F, 0F);
