        ...
        if (entity != null) {
            switch (ID) {
                case GuiIDFatInfuser:
                    if (entity instanceof TileEntityFatInfuser)
                        return new ContainerFatInfuser(player.inventory, (TileEntityFatInfuser) entity);
                    break;
                case GuiIDCookingPot:
                    if (entity instanceof TileEntityCookingPot)
                        return new ContainerCookingPot((TileEntityCookingPot) entity);
                    break;
            }
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (entity != null) {
            switch (ID) {
                case GuiIDFatInfuser:
                    if (entity instanceof TileEntityFatInfuser)
                        return new GuiFatInfuser(player.inventory, (TileEntityFatInfuser) entity);
                    break;
                case GuiIDCookingPot:
                    if (entity instanceof TileEntityCookingPot) return new GuiCookingPot((TileEntityCookingPot) entity);
                    break;
            }
        } else if (ID == GuiIDSchnitzelBackpack) {
