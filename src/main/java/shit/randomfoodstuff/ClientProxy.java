...
import shit.randomfoodstuff.guide.content.*;
...
import shit.randomfoodstuff.render.model.*;
...
public class ClientProxy implements IProxy {
    ...
    public void registerGuide() {
        ...
        //Items
        GuideRegistry.addGuideArticle("items.benni", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomItems.itemBenni))
                .addRecipes(new ItemStack(RandomItems.itemBenni, 1, 1))
                .addRecipes(new ItemStack(RandomItems.itemBenni, 1, 2))
                .addRecipes(new ItemStack(RandomItems.itemBobTheBenni))
        );
        GuideRegistry.addGuideArticle("items.arthur", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomItems.itemArthur))
                .addRecipes(new ItemStack(RandomItems.itemArthur, 1, 1))
        );
        GuideRegistry.addGuideArticle("items.drinks", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomItems.itemDrink))
                .addRecipes(new ItemStack(RandomItems.itemDrink, 1, 1))
                .addRecipes(new ItemStack(RandomItems.itemDrink, 1, 2))
                .addRecipes(new ItemStack(RandomItems.itemDrink, 1, 3))
                .addRecipes(new ItemStack(RandomItems.itemDrink, 1, 4))
        );
        GuideRegistry.addGuideArticle("items.baguette", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomItems.itemMagicBaguette))
        );
        GuideRegistry.addGuideArticle("items.lauch", new SimpleGuideArticle());

        //Schnitzel
        GuideRegistry.addGuideArticle("items.schnitzel.schnitzel", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomItems.itemWarpingSchnitzel))
                .addRecipes(new ItemStack(RandomItems.itemFlyingSchnitzel))
                .addRecipes(new ItemStack(RandomItems.itemSchnitzel))
                .addRecipes(new ItemStack(RandomItems.itemSchnitzel, 1, 1))
                .addRecipes(new ItemStack(RandomItems.itemSchnitzel, 1, 2))
        );
        GuideRegistry.addGuideArticle("items.schnitzel.backpack", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomItems.itemSchnitzelBackpack))
        );

        //Blocks
        GuideRegistry.addGuideArticle("blocks.fatInfuser", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomBlocks.blockFatInfuser))
                .addRecipes(new ItemStack(RandomItems.itemFat)));
        GuideRegistry.addGuideArticle("blocks.awfull", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomBlocks.blockAwfull))
                .addRecipes(new ItemStack(RandomItems.itemAwfullBreaker))
        );

        //Cooking
        GuideRegistry.addGuideArticle("cooking.cookingPot", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomBlocks.blockCookingPot))
        );
        GuideRegistry.addGuideArticle("cooking.soupLadle", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomItems.itemSoupLadle))
        );
        GuideRegistry.addGuideArticle("cooking.spices", new SimpleGuideArticle()
                .addRecipes(new ItemStack(RandomItems.itemSuperMushroom))
                .addRecipes(new ItemStack(RandomItems.itemSuperFatBenni))
                .addRecipes(new ItemStack(RandomItems.itemClubMate))
                .addRecipes(new ItemStack(RandomItems.itemFloatingSauce))
                .addRecipes(new ItemStack(RandomItems.itemMutantLauch))
        );
