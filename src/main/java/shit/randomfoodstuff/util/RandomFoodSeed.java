...
public class RandomFoodSeed extends ItemFood implements IPlantable {
    ...
    public RandomFoodSeed(int parHealAmount, float parSaturationModifier, Block parBlockPlant, Block parSoilBlock) {
